"""Core color detection module (packaged).

This mirrors the functionality exposed at the repository root but lives
inside a proper package so the project can be built and installed.
"""
...
def run_interactive(image_path: str, color_db_path: str) -> None:
    # Lazy import cv2 so importing the package doesn't require OpenCV
    import cv2
